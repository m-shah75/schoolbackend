...
<head>
    ...
    <title>AKKHOR | همه والدین</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url() ?>asset/<?php echo base_url()?>asset/<?php echo base_url()?>asset/img/favicon.png">
    <!-- Normalize CSS -->
