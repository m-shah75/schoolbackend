...
<head>
    ...
    <title>AKKHOR | همه کلاس ها</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url() ?>asset/<?php echo base_url()?>asset/img/favicon.png">
    <!-- Normalize CSS -->
                    ...
                    <form class="mg-b-20">
                        <div class="row gutters-8">
                            ...
                            <div class="col-4-xxxl col-xl-4 col-lg-3 col-12 form-group">
                                <input type="text" name="nameSearch" placeholder="جستجو براساس نام کلاس" class="form-control">
                            </div>
